...
const requiredPackedFiles = [
  ...
  'registry/vue/folder-tabs/assets/paper/03-fibrous-cotton-rag-hybrid-strong-2048-tile.png',
  'registry/vue/folder-tabs/assets/paper/03-fibrous-cotton-rag-hybrid-strong-2048-repeat-3x3.png',
  'registry/vue/folder-tabs/assets/paper/03-fibrous-cotton-rag-hybrid-strong-512-density4-tile.png',
  'registry/vue/folder-tabs/assets/paper/03-fibrous-cotton-rag-hybrid-strong-228-density9-tile.png',
  'registry/vue/folder-tabs/assets/paper/05-creamy-fine-tooth-hybrid-strong-2048-tile.png',
  'registry/vue/folder-tabs/assets/paper/05-creamy-fine-tooth-hybrid-strong-2048-repeat-3x3.png',
  'registry/vue/folder-tabs/assets/paper/05-creamy-fine-tooth-hybrid-strong-512-density4-tile.png',
  'registry/vue/folder-tabs/assets/paper/05-creamy-fine-tooth-hybrid-strong-228-density9-tile.png',
  'registry/vue/folder-tabs/assets/paper/paper-watercolor-rough.jpg',
  'registry/vue/folder-tabs/folder-tabs.json',
  'registry/vue/folder-tabs/index.ts',
  'registry/vue/folder-tabs/paperTextures.ts',
  ...
  'src/components/folder-tabs/assets/paper/03-fibrous-cotton-rag-hybrid-strong-2048-tile.png',
  'src/components/folder-tabs/assets/paper/03-fibrous-cotton-rag-hybrid-strong-2048-repeat-3x3.png',
  'src/components/folder-tabs/assets/paper/03-fibrous-cotton-rag-hybrid-strong-512-density4-tile.png',
  'src/components/folder-tabs/assets/paper/03-fibrous-cotton-rag-hybrid-strong-228-density9-tile.png',
  'src/components/folder-tabs/assets/paper/05-creamy-fine-tooth-hybrid-strong-2048-tile.png',
  'src/components/folder-tabs/assets/paper/05-creamy-fine-tooth-hybrid-strong-2048-repeat-3x3.png',
  'src/components/folder-tabs/assets/paper/05-creamy-fine-tooth-hybrid-strong-512-density4-tile.png',
  'src/components/folder-tabs/assets/paper/05-creamy-fine-tooth-hybrid-strong-228-density9-tile.png',
  'src/components/folder-tabs/assets/paper/paper-watercolor-rough.jpg',
  'src/components/folder-tabs/folder-tabs.css',
  'src/components/folder-tabs/index.ts',
  'src/components/folder-tabs/paperTextures.ts',
  'src/vite-env.d.ts',
];
