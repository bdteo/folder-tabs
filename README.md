...
| `stackRotation` | `none \| folders \| pieces` | `none` | Controls optional tucked-stack rotation. `folders` rotates the background folder sheets while keeping tab handles straight; `pieces` rotates the whole folder piece, including the tab. |
